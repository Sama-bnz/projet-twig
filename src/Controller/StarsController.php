...
class StarsController extends AbstractController
{
    ...
    public function stars()
    {
        ...
        return $this->render('show_stars.html.twig', ['categories'=> $categories]);
    }


    /**
     * @Route("showStars/{id}", name="showStars")
     */
    public function showStars($id)
    {
        ...
        return $this->render('show_solo_stars.html.twig', ['stars'=> $stars[$id]
